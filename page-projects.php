...
<div class="container-fluid" id="projectsIntro">
        <div class="row">
            <div class="col-sm-12 text-center bottomMargin">
                <i class="fas fa-code projectsIntroIcon"></i>
                <h1 class="display-2">Projects</h1>
            </div>
        </div>

                <!-- <p class="bottomMargin">Websites | Games | Other</p> -->
                <div class="row">
                    <div class="col-sm-4">
                    <div class="card text-center transparent">
                        ...
                        <div class="card-body">
                        <h2>Websites</h2>
                        <p><a class="btn btn-projects btn-lg" href="https://daveymason.com/projects/websites" role="button">Let's Go <i class="far fa-arrow-alt-circle-right btnRightArrow"></i></a></p>
                        </div>
                    </div> <!-- card -->
                    </div> <!-- col-sm-4 -->
                    ...
                    <div class="card text-center transparent">
                        ...
                        <div class="card-body">
                        <h2>Games</h2>
                        <p><a class="btn btn-projects btn-lg" href="https://daveymason.com/projects/games" role="button">Let's Go <i class="far fa-arrow-alt-circle-right btnRightArrow"></i></a></p>
                        </div>
                    </div> <!-- card -->
                    </div> <!-- col-sm-4 -->
                    ...
                    <div class="card text-center transparent">
                        ...
                        <div class="card-body">
                        <h2>Other</h2>
                        <p><a class="btn btn-projects btn-lg" href="https://daveymason.com/projects/other" role="button">Let's Go <i class="far fa-arrow-alt-circle-right btnRightArrow"></i></a></p>
                        </div>
                    </div> <!-- card -->
                    </div> <!-- col-sm-4 -->
                </div> <!--row-->
          ...
          <div class="col-sm-12 col-xl-6 text-center">
              <div class="card cardNav">
                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="col-xs-12 col-md-6">
                          <a target="_blank" href="https://terrifictaiyuan.com"><img class="img-responsive hvr-float-shadow bottomMargin" src="/daveymason.com/wp-content/themes/Personal/Images/projectsTerrificTaiyuan.png" alt="Davey Mason" width="75%" height="auto"></a>
                      </div>
                          <div class="col-xs-12 col-md-6">
          ...
          <div class="col-sm-12 col-xl-6 text-center">
              <div class="card cardNav">
                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="col-xs-12 col-md-6">
                          <a target="_blank" href="http://bigpixmedia.ie"><img class="img-responsive hvr-float-shadow bottomMargin" src="/daveymason.com/wp-content/themes/Personal/Images/projectsBigPix.png" alt="Davey Mason" width="75%" height="auto"></a>
                      </div>
                          <div class="col-xs-12 col-md-6">
          ...
          <div class="col-sm-12 col-xl-6 text-center">
              <div class="card bottomMargin cardNav">
                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="col-xs-12 col-md-6">
                          <a target="_blank" href="https://getthejobyouwant.ie"><img class="img-responsive hvr-float-shadow bottomMargin" src="/daveymason.com/wp-content/themes/Personal/Images/projectsGTJYW.png" alt="Davey Mason" width="75%" height="auto"></a>
                      </div>
                          <div class="col-xs-12 col-md-6">
          ...
          <div class="col-sm-12 col-xl-6 text-center">
              <div class="card bottomMargin cardNav">
                  ...
                  <div class="card-body">
                      <div class="row">
                          <div class="col-xs-12 col-md-6">
                          <a target="_blank" href="https://learnwithdavey.com"><img class="img-responsive hvr-float-shadow bottomMargin" src="/daveymason.com/wp-content/themes/Personal/Images/projectsLearnWithDavey.png" alt="Davey Mason" width="75%" height="auto"></a>
                      </div>
                          <div class="col-xs-12 col-md-6">
